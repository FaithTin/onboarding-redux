...
import ThreeDots from "./components/LoadingCard.jsx";
...
function App() {
    ...
    const {getContactList,addNewContact,updateContactDetails,deleteContacts,cleanContact,setContactDetails,
        cleanContactDetails} = useActions();
